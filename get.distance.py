...
for line in open_input.readlines(): # for each line in the input file
	...
	abs_dif = abs(position - enhancer_start) # compute the absolute value of the difference between position and enhancer_start

	if abs_dif < x : # if this absolute value is lower than x
		x = abs_dif  # this value will now be your current x
